...
def densenet121_racnn_crops(weights=None, num_classes=200, glimpse_only=False,
        freeze_conv1=False, freeze_conv2=False):
    if weights is not None:
        base_pretrained = False
    else:
        base_pretrained = True
    model = DenseNet_RACNN_Crops(num_classes=200, base_pretrained=base_pretrained)
...
class DenseNet_RACNN_Crops(nn.Module):
    def __init__(self, num_classes=200, glimpses=2, base_pretrained=True,
        ...
        """
        super(DenseNet_RACNN_Crops, self).__init__()
        ...
        self.fc1 = nn.Linear(self.num_fltrs * (self.g+1), self.num_fltrs/2)
