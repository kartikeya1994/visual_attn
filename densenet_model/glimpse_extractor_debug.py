...
def densenet121_racnn_glimpse_extractor(weights=None, num_classes=200, 
    ...
    model = DenseNet_RACNN_Glimpse_Extractor(num_classes=200, base_pretrained=base_pretrained)
...
class DenseNet_RACNN_Glimpse_Extractor(nn.Module):
    def __init__(self, num_classes=200, glimpses=2, base_pretrained=True,
        ...
        # wo GAP self.glimpse_fc = nn.Linear(self.num_fltrs * conv_dim * conv_dim, self.glimpse_dim * self.g)
    ...
    def forward(self, x):
        ...
        # wo GAP f = f.view(s, self.num_fltrs * self.conv_dim * self.conv_dim)
