...
class DenseNet_RACNN_Glimpse_Extractor(nn.Module):
    def __init__(self, num_classes=200, glimpses=2, base_pretrained=True,
        ...
        4 (4, 1024, 9, 9)
        """
        self.skip_concat_dim = 37**2 + 9**2
        if skip_con:
            self.conv1.features.denseblock2.register_forward_hook(store_activations)
            self.conv1.features.denseblock4.register_forward_hook(store_activations)
