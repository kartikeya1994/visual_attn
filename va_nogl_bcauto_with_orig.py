...
from densenet_with_orig import densenet121_racnn_gl_with_orig
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'validation']:
            ...
            for data in tqdm(dataloders[phase]):
                ...
                loss = l + lamb*(lb1+lb2+ub1+ub2) + lamb2*dist_constr
                
                l1 += l.data[0]
                l2 += (lamb*(lb1+lb2+ub1+ub2)).data[0]
            ...
            print('L1: {} L_Bound: {} L_Dist: {}'.format(l1/float(dataset_sizes[phase]),
...
base_model_weights = './saved/va_nogl_bcauto_84_0.705625.pth'
model_ft = densenet121_racnn_gl_with_orig(base_model_weights=base_model_weights, use_gpu=use_gpu, glimpse_size=35) 
