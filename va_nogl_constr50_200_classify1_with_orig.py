...
from densenet_with_orig_classify1 import densenet121_racnn_gl_with_orig
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'validation']:
            ...
            for data in tqdm(dataloders[phase]):
                ...
                loss = l + l_conv1 + lamb1*(lb1+lb2+ub1+ub2+ub3) + lamb2*dist_constr
                
                l1 += l.data[0]
                l2 += (lamb1*(lb1+lb2+ub1+ub2+ub3)).data[0]
...
model_ft = densenet121_racnn_gl_with_orig(use_gpu=use_gpu, glimpse_size=35) 
